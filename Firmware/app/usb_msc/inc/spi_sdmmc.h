...
#define SDMMC_PIN_SCK  GPIO_SD_CARD_SPI_SCK
#define SDMMC_PIN_MISO GPIO_SD_CARD_SPI_MISO
#define SDMMC_PIN_MOSI GPIO_SD_CARD_SPI_MOSI
#define SDMMC_PIN_CS   GPIO_SD_CARD_SPI_CS
